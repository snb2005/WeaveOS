...
const FilesEnhanced = ({ onOpenFile, windowId }: FilesProps) => {
  ...
  return (
    <div className="w-full h-full bg-zinc-900 rounded-xl border border-zinc-700/50 flex flex-col overflow-hidden">
      {/* Toolbar */}
      <div className="bg-zinc-800/80 border-b border-zinc-700/50 p-4">
        {/* Navigation Controls */}
        <div className="flex items-center gap-4 mb-4">
          <div className="flex items-center gap-2">
            <button
              ...
              className="p-2 rounded-lg bg-zinc-700/50 hover:bg-zinc-600/50 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
              title="Back"
            >
            ...
            <button
              ...
              className="p-2 rounded-lg bg-zinc-700/50 hover:bg-zinc-600/50 transition-colors"
              title="Refresh"
            >
              <span className="text-white">⟳</span>
            </button>
          ...
          <div className="flex-1 max-w-md">
            <input
              ...
              className="w-full px-4 py-2 bg-zinc-800/50 border border-zinc-600/50 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:border-blue-400 transition-colors"
            />
          </div>
          ...
          <div className="flex items-center gap-2">
            <div className="flex items-center gap-1 bg-zinc-700/50 rounded-lg p-1">
              ...
              <button
                ...
                className={`p-2 rounded transition-colors ${
                  viewMode === 'details' ? 'bg-blue-500 text-white' : 'text-white/70 hover:text-white'
                }`}
                title="Details View"
              >
                ≡
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <div className="w-64 bg-zinc-800/80 border-r border-zinc-700/50 flex flex-col">
          ...
          {/* File Operations */}
          <div className="p-4 border-t border-zinc-700/50 mt-auto">
            <div className="space-y-2">
              <button
                onClick={createNewFolder}
                className="w-full flex items-center gap-3 px-3 py-2 rounded-lg text-gray-300 hover:text-white hover:bg-zinc-700/50 transition-all"
              >
                <span>📁</span>
        ...
        <div className="flex-1 flex flex-col">
          {/* Sort Controls */}
          <div className="bg-zinc-800/50 border-b border-zinc-700/50 px-4 py-2 flex items-center gap-4">
            <div className="flex items-center gap-2">
              <span className="text-gray-400 text-sm">Sort by:</span>
              <select
                value={sortBy}
                onChange={(e) => setSortBy(e.target.value as SortBy)}
                className="bg-zinc-700/50 border border-zinc-600/50 rounded px-2 py-1 text-white text-sm focus:outline-none focus:border-blue-400"
              >
                <option value="name" className="bg-zinc-800">Name</option>
                <option value="size" className="bg-zinc-800">Size</option>
                <option value="type" className="bg-zinc-800">Type</option>
                <option value="modified" className="bg-zinc-800">Modified</option>
              </select>
              <button
            ...
            <label className="flex items-center gap-2 text-gray-400 text-sm">
              <input
                ...
                className="w-4 h-4 rounded border-zinc-600/50 bg-zinc-700/50 text-blue-500"
              />
              Show hidden files
            </label>
      ...
      {contextMenu && (
        <div
          className="fixed bg-zinc-800/95 backdrop-blur-sm border border-zinc-600/50 rounded-lg py-2 z-50 min-w-48"
          ...
          {contextMenu.item ? (
            <>
              <button
                ...
                className="w-full px-4 py-2 text-left text-white hover:bg-zinc-700/50 transition-colors"
              >
