...
const TextEditorEnhanced: React.FC<TextEditorProps> = ({ 
  ...
  const [theme, setTheme] = useState<'dark' | 'light'>(editorState?.theme || 'dark');
  ...
  }, [windowId, content, isAutoSave, fontSize, wordWrap, showLineNumbers, theme, cursorPosition, updateWindowState]);
  ...
  return (
    <div className="w-full h-full bg-zinc-900 rounded-xl border border-zinc-700/50 flex flex-col overflow-hidden">
        ...
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <select
              ...
              className="bg-zinc-700/50 border border-zinc-600/50 rounded-lg px-3 py-2 text-white text-sm focus:outline-none focus:border-blue-400"
              defaultValue=""
            >
              <option value="" className="bg-zinc-800">Insert Template</option>
              <option value="html" className="bg-zinc-800">HTML Document</option>
              <option value="react" className="bg-zinc-800">React Component</option>
              <option value="function" className="bg-zinc-800">Function</option>
              <option value="class" className="bg-zinc-800">Class</option>
            </select>
            ...
            <button
              ...
              className={`px-4 py-2 rounded-lg text-sm font-medium transition-all ${
                hasUnsavedChanges
                  ...
                  : 'bg-zinc-700/50 text-white/50 cursor-not-allowed'
              }`}
              title="Save (Ctrl+S)"
            >
              💾 Save
          ...
          <div className="flex items-center gap-1 bg-zinc-700/50 rounded-lg p-1">
            <button
              ...
              className={`px-2 py-1 rounded text-xs ${
                theme === 'light' ? 'bg-blue-500 text-white' : 'text-white/70 hover:text-white'
              }`}
            >
              ☀️
            </button>
            <button
              ...
              className={`px-2 py-1 rounded text-xs ${
                theme === 'dark' ? 'bg-blue-500 text-white' : 'text-white/70 hover:text-white'
              }`}
            >
              🌙
            </button>
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        {showLineNumbers && (
          <div 
            className="w-16 bg-zinc-800/80 border-r border-zinc-700/50 text-right text-gray-500 font-mono text-sm py-4 px-2 overflow-hidden"
        ...
        <div className="flex-1 relative">
          <textarea
            ...
            className="w-full h-full resize-none border-none outline-none p-4 bg-zinc-900/50 text-white font-mono leading-6"
            style={{
      ...
      {/* Status Bar */}
      <div className="bg-zinc-800/80 border-t border-zinc-700/50 px-4 py-2 text-sm text-gray-400 flex items-center justify-between">
